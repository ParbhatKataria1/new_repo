import { Box, Button, Center, Container, Divider, Flex, Grid, GridItem, Heading, HStack, Image, ListItem, Radio, RadioGroup, Select, Stack, Text, UnorderedList, useRadio, useRadioGroup } from '@chakra-ui/react'
                ...
                <Slider {...settings}>
                    {
                        Array(4).fill('').map((el, ind) => {
                            ...
                            return <div w={'200px'} zIndex='100' key={el.id}>
                                <Image  src={`${this.image.furl}${v}${this.image.burl}`}  />
                                {/* <ReactImageMagnify {...{
                                    smallImage: {
